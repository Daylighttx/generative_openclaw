...
`,
  ...
  it("applies HEARTBEAT.md gating rules across file states and triggers", async () => {
    const cases: Array<{
      ...
      expectedSkipReason?: "empty-heartbeat-file" | "no-tasks-due";
      ...
      {
        name: "empty file + interval proceeds to AgentMind check",
        fileState: "empty",
        expectedStatus: "skipped",
        expectedSkipReason: "no-tasks-due",
        expectedSendCalls: 0,
        expectedReplyCalls: 0,
      },
      {
        name: "legacy comment-only template + interval proceeds to AgentMind check",
      ...
      {
        name: "fenced empty template + interval proceeds to AgentMind check",
